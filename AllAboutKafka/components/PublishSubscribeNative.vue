<template>
  <div class="ps2-wrap">
    <div class="ps2-scroll">
      <div class="ps2-canvas">
        <svg class="ps2-lines" viewBox="0 0 1100 560" aria-hidden="true">
          <defs>
            <marker id="ps2-arrow" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto">
        ...
        <div v-click="2" class="ps2-card ps2-top t3 ps2-stage">Database<br />Server</div>
        <div v-click="2" class="ps2-card ps2-top t4 ps2-stage">Database<br />Slave</div>
        <div v-click="2" class="ps2-card ps2-top t5 ps2-stage">Chat<br />Server</div>
        <div v-click="2" class="ps2-card ps2-top t6 ps2-stage">Shopping<br />Cart</div>
        <div v-click="2" class="ps2-card ps2-top t7 ps2-stage">Backend<br />Server</div>

        <div v-click="1" class="ps2-card ps2-legacy ps2-stage">Metrics<br />Server</div>

        <div v-click="3" class="ps2-card ps2-bus metrics ps2-stage">Metrics<br />Pub/Sub</div>
        <div v-click="4" class="ps2-card ps2-bus logging ps2-stage">Logging<br />Pub/Sub</div>
        <div v-click="4" class="ps2-card ps2-bus tracking ps2-stage">Tracking<br />Pub/Sub</div>

        <div class="ps2-card ps2-bottom b2">Metrics<br />Analysis</div>
        <div v-click="3" class="ps2-card ps2-bottom b1 ps2-stage">Metrics UI</div>
        <div v-click="3" class="ps2-card ps2-bottom b3 ps2-stage">Active<br />Monitoring</div>
        <div v-click="3" class="ps2-card ps2-bottom b4 ps2-stage">Database<br />Monitor</div>

        <div v-click="4" class="ps2-card ps2-bottom b5 ps2-stage">Log<br />Search</div>
        <div v-click="4" class="ps2-card ps2-bottom b6 ps2-stage">Security<br />Analysis</div>
        <div v-click="4" class="ps2-card ps2-bottom b7 ps2-stage">Offline<br />Processing</div>
    ...
    <div class="ps2-legend">
      ...
      <p v-click="2">2. Point-to-point integrations explode into hard-to-maintain coupling.</p>
      <p v-click="3">3. Metrics Pub/Sub decouples producers from consumers.</p>
      <p v-click="4">4. Additional Pub/Sub domains scale the same pattern for logs and tracking.</p>
      <p v-click="5">5. Final state: clean fan-out architecture, lower service-to-service complexity.</p>
    </div>
  </div>
</template>
