      ...
      <div class="ps2-canvas">
        <svg class="ps2-lines" viewBox="0 0 1100 560" aria-hidden="true">
          ...
          <g v-if="props.step === 2" class="ps2-layer">
            <path
              :id="pid('s2-metrics-ui')"
              d="M80 114 V230 H95 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-metrics-analysis')"
              d="M80 114 V215 H265 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-active-monitoring')"
              d="M230 114 V198 H435 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-db-monitor')"
              d="M380 114 V184 H605 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-dbserver-to-active')"
              d="M530 114 V210 H435 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-chat-to-dbmonitor')"
              d="M680 114 V222 H605 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-shopping-to-analysis')"
              d="M830 114 V205 H265 V448"
              :marker-end="markerUrl"
            />
            <path
              :id="pid('s2-backend-to-ui')"
              d="M980 114 V230 H95 V448"
              :marker-end="markerUrl"
            />
          </g>
          ...
          <g v-if="props.step === 4" class="ps2-layer">
            <path
              v-for="x in step4.producerLeftXs"
              :key="`step4-left-${x}`"
              :d="`M${x} 114 V${step4.topY1}`"
            />
            <path
              v-for="x in step4.producerRightXs"
              :key="`step4-right-${x}`"
              :d="`M${x} 114 V${step4.topY2}`"
            />

            <path
              :id="pid('s4-top-bus')"
              :d="`M${step4.topRailStartX} ${step4.topY1} H${step4.topRailEndX}`"
            />
            <path
              :id="pid('s4-top-bus-2')"
              :d="`M${step4.topRailStartX} ${step4.topY2} H${step4.topRailEndX}`"
            />
            <path
              :id="pid('s4-top-bus-3')"
              :d="`M${step4.topRailStartX} ${step4.topY3} H${step4.thirdRailEndX}`"
            />
            ...
            <path
              :d="`M${step4.metricsPubSubX} ${step4.pubSubBottomY} V${step4.metricsBottomBusY}`"
            />
            <path
            ...
            />
            <path
              :id="pid('s4-metrics-to-ui')"
              :d="`M95 ${step4.metricsBottomBusY} V${step4.consumerTopY}`"
              :marker-end="markerUrl"
            />
            <path
            ...
            <path
              :id="pid('s4-logging-bottom-bus')"
              :d="`M${step4.loggingPubSubX} ${step4.pubSubBottomY} V${step4.metricsBottomBusY}`"
            />
            <path
              :d="`M${step4.loggingPubSubX} ${step4.metricsBottomBusY} H${step4.logBottomBusEndX}`"
            />
            <path
        ...
        <div v-if="props.step === 1" class="ps2-card ps2-legacy">
          Metrics<br />Server
        </div>
